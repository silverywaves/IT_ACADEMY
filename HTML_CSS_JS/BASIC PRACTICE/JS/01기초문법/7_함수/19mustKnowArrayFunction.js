...
// 1. 초기값인 0 이 p 에 입력
// 2. numbers array 의 첫번째 값인 1 이 n 에 입력
// 3. p + n 즉, 1 + 8 의 결과값인 1 이 반환
// 4. 3 에서 반환한 값(1)이 p 에 입력
// 5. 어레이의 두번째 값인 8 이 n 에 입력
// 6. p + n 즉, 1+ 8 의 결과값인 9 가 반환
// 7. 6 에서 반환한 값(9)가 p 에 입력
// 8. numbers 리스트의 모든 값들을 다 순회할때까지 반복. 결국 모든 값을 다 더한 25 반환
